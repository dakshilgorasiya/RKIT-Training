...
namespace MeasurePerformanceORM.Models
{
    public partial class employeeContext : DbContext
    {
        ...
        public virtual DbSet<EmpDept> EmpDepts { get; set; } = null!;
        public virtual DbSet<EmpName> EmpNames { get; set; } = null!;
        public virtual DbSet<T01> T01s { get; set; } = null!;
        public virtual DbSet<T01View> T01Views { get; set; } = null!;
        public virtual DbSet<T02> T02s { get; set; } = null!;
        public virtual DbSet<T03> T03s { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseMySql("server=localhost;database=employee;user=root;password=Dakshil@123", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.43-mysql"));
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<T02>(entity =>
            {
                ...
                entity.HasOne(d => d.T02f08Navigation)
                    .WithMany(p => p.T02s)
