$(() => {
    let textAreaInstance = $("#textArea").dxTextArea({
        ...
        // default: false
        // Use the minHeight and maxHeight properties to set the height that the adapted TextArea can occupy. minHeight specifies the initial height.
    ...
    //textAreaInstance.element().focusin();

    // Refreshes the UI component after a call of the beginUpdate() method.
    //textAreaInstance.endUpdate();
    ...
    let instance = DevExpress.ui.dxTextArea.getInstance(element);
    //console.log(instance === textAreaInstance);

    // Gets the UI component's instance. Use it to access other methods of the UI component.
    instance = textAreaInstance.instance();
    //console.log(instance === textAreaInstance);

    // Detaches all event handlers from a single event.
    //textAreaInstance.off("valueChanged");

    // Detaches a particular event handler from a single event.
    //textAreaInstance.off("valueChanged", cb1);

    // To attach event listener
    //textAreaInstance.on("valueChanged", cb1);
    ...
    //console.log(textAreaInstance.option());

    // Gets the value of a single property.
    //console.log(textAreaInstance.option("readOnly"));

    // Updates the value of a single property.
    //textAreaInstance.option("readOnly", false);

    // Updates the values of several properties.
    //textAreaInstance.option({
    //    "readonly": false,
    //    value: null
    //});
    ...
    //textAreaInstance.registerKeyHandler("w", function () {
    ...
    //textAreaInstance.reset("reset");

    // Resets a property to its default value.
    //textAreaInstance.resetOption("value");
