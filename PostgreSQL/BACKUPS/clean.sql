...
\restrict LPmNNUpbfGIy4SDeT36hujFgWY8iSCrXnbsOckBSFaKLdLfzAEMKam0vVCqCA5F
...
DROP POLICY department_managers ON public.departments;
ALTER TABLE ONLY public.products DROP CONSTRAINT products_group_id_fkey;
ALTER TABLE ONLY employee.empt02 DROP CONSTRAINT fk_t02f08;
ALTER TABLE ONLY employee.empt02 DROP CONSTRAINT empt02_t02f08_fkey;
DROP TRIGGER log_delete_employee ON employee.empt02;
DROP INDEX public.body_search_fts;
ALTER TABLE ONLY public.sales_stats DROP CONSTRAINT sales_stats_pkey;
ALTER TABLE ONLY public.sales DROP CONSTRAINT sales_pkey;
ALTER TABLE ONLY public.products DROP CONSTRAINT products_pkey;
ALTER TABLE ONLY public.product_groups DROP CONSTRAINT product_groups_pkey;
...
ALTER TABLE ONLY employee.empt03 DROP CONSTRAINT t03f01_pk;
ALTER TABLE ONLY employee.empt02 DROP CONSTRAINT t02f04_unique;
ALTER TABLE ONLY employee.empt02 DROP CONSTRAINT empt02_t02f04_key;
ALTER TABLE ONLY employee.empt02 DROP CONSTRAINT empt02_pkey;
ALTER TABLE ONLY employee.empt01 DROP CONSTRAINT empt01_t01f02_key;
ALTER TABLE ONLY employee.empt01 DROP CONSTRAINT empt01_pkey;
ALTER TABLE public.products ALTER COLUMN product_id DROP DEFAULT;
ALTER TABLE public.product_groups ALTER COLUMN group_id DROP DEFAULT;
ALTER TABLE public.posts ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.departments ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.contacts ALTER COLUMN id DROP DEFAULT;
DROP TABLE public.sales_stats;
DROP TABLE public.sales;
DROP SEQUENCE public.products_product_id_seq;
DROP TABLE public.products;
DROP SEQUENCE public.product_groups_group_id_seq;
DROP TABLE public.product_groups;
DROP SEQUENCE public.posts_id_seq;
DROP TABLE public.posts;
DROP VIEW public.emp_name;
DROP VIEW public.emp_dept;
DROP SEQUENCE public.departments_id_seq;
DROP TABLE public.departments;
DROP TABLE public.dense_ranks;
DROP TABLE public.demo;
DROP SEQUENCE public.contacts_id_seq;
DROP TABLE public.contacts;
DROP TABLE employee.empt03;
DROP TABLE employee.empt02;
DROP TABLE employee.empt01;
DROP PROCEDURE public.double_number(INOUT p_num integer);
DROP FUNCTION employee.log_delete_employee_function();
DROP FUNCTION employee.get_employee_by_department(p_dept_name character varying);
DROP PROCEDURE employee.fetch_employee(OUT p_employee text);
DROP PROCEDURE employee.count_employee(IN p_dept_name character varying, OUT p_count integer);
DROP FUNCTION employee.calculate_age(p_birth_date date);
...
\unrestrict LPmNNUpbfGIy4SDeT36hujFgWY8iSCrXnbsOckBSFaKLdLfzAEMKam0vVCqCA5F
